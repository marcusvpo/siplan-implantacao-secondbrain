...
tags:
  ...
  - #fluxo
---
# Fluxo de Implantação Siplan

Este é o mapa de conteúdo que orquestra o processo de implantação de softwares da Siplan nos cartórios. O fluxo é desenhado para ser sequencial e condicional.

## Etapas do Processo

1. [[[Processo] 1. Início do Chamado de Implantação]]
2. **Gates Iniciais (Paralelos):**
   - [[[Processo] 2. Levantamento de Infraestrutura]]
   - [[[Processo] 3. Análise de Aderência do Processo de Negócio]]
3. [[[Processo] 4. Tratamento de Impedimentos da Análise de Aderência]]
4. **Execução Técnica (Pós-Gates):**
   - [[[Processo] 5. Conversão do Banco de Dados]]
   - [[[Processo] 6. Homologação da Conversão de Dados]]
   - [[[Processo] 7. Agendamento da Implantação Funcional]]
...
- [[[Oportunidade] Evolução e Rollout do Hub]]
