...
| `[Processo] 2. Levantamento de Infraestrutura` | `2-Áreas/Infraestrutura Técnica/[Processo] 2. Levantamento...` | Infraestrutura | Coleta automatizada de hardware via scripts e link público no Hub, com validação automática de conformidade. |
| `[Processo] 3. Análise de Aderência do Processo de Negócio` | `2-Áreas/Implantação Funcional/[Processo] 3. Análise de Aderência...` | Implantação | Diagnóstico estrutural e funcional gerado e salvo nativamente no Hub via formulário versionado na Área dos Implantadores. |
...
| `[Manual] Passo a Passo - Novas Automações de Homologação` | `2-Áreas/Siplan Hub/Automações/[Manual] Passo a Passo - Novas Automações de Homologação.md` | Backend / n8n | Detalha a automação de novas homologações e pareceres (aprovadas/reprovadas) com busca dinâmica e fallback. |
| `[Manual] Passo a Passo - Automação de Configuração de Ambiente` | `2-Áreas/Siplan Hub/Automações/[Manual] Passo a Passo - Automação de Configuração de Ambiente.md` | Backend / n8n | Orienta a configuração do webhook e fluxo do n8n para solicitar a preparação de infraestrutura e banco. |
| `[Conceito] Ideias de Automações Operacionais - Siplan HUB` | `2-Áreas/Siplan Hub/Automações/[Conceito] Ideias de Automações Operacionais - Siplan HUB.md` | Backend / n8n | Detalhamento de requisitos, escopo de campos e mapeamento de destinatários das automações propostas. |
...
| [[Modelo] Template - Analise de Aderencia] | `3-Recursos/Procedimentos e Manuais/[Modelo] Template...` | Template | Matriz base de perguntas e tópicos investigativos gerenciada e versionada dinamicamente no Siplan Hub. |
